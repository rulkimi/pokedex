...
export default function DetailImage({
  ...
  const getRandomAnimation = () => {
    const animations = [
      async () => {
        ...
        for (const pos of sequence) { await controls.start(pos); }
      },
      async () => {
  ...
  return (
    <section className="relative flex justify-center items-center w-full min-h-[250px]">
      <motion.div 
        animate={controls} 
      ...
      >
        <PokemonImage
          ...
          imageSize={220}
          className="object-cover group-hover:scale-110 transition-transform duration-300 drop-shadow-2xl"
          loading="eager"
        />
      </motion.div>
    </section>
